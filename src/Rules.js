...
export class RulesButton extends React.Component {
  render() {
    return (
      <div className="rules align-right">
        <button
          className="rules-btn white clickable"
          onClick={() => {
...
export class ModalContent extends React.Component {
  render() {
    return (
      <div id="modal" className="center-content">
        <div id="modal-header" className="grid-column">
          <p>RULES</p>
          <button
            className="modal-btn center-content align-center-right clickable"
            onClick={() => {
