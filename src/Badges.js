...
export class PaperBadge extends React.Component {
  render() {
    return (
      <div
        className={`badge-${this.props.size} paper center-content center-item`}
        id="paper"
      >
        <svg
          id="paper-image"
...
export class ScissorsBadge extends React.Component {
  render() {
    return (
      <div
        className={`badge-${this.props.size} scissors center-content center-item`}
        id="scissors"
      >
        <svg
          id="scissors-image"
...
export class RockBadge extends React.Component {
  render() {
    return (
      <div className={`badge-${this.props.size} rock center-content`} id="rock">
        <svg
          id="rock-image"
          xmlns="http://www.w3.org/2000/svg"
          width="48"
